...
function connect_ajax(proto) {
  ...
  function request(runner, step, data_, expected) {
    ...
    .fail((xhr, textStatus, errorThrown) => {
      var data = { statusText: xhr.statusText, status: xhr.status, textStatus: textStatus, responseText: xhr.responseText, headers: xhr.getAllResponseHeaders(), error: errorThrown };  
      correctCallback(runner, step, data, expected);
