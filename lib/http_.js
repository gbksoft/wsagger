...
>>>>>>> 3c3deb4d66b1bff1b052794fa8c779fd25c44f5b
      if (responseData && (typeof responseData === 'object')) { data.parsed = responseData; }
      correctCallback(runner, step, data, expected);
    })
    .fail((xhr, textStatus, errorThrown) => {
<<<<<<< HEAD
      var data = { status: xhr.status, textStatus: textStatus, responseText: xhr.responseText, headers: xhr.getAllResponseHeaders(), errorThrown: errorThrown };  
=======
      var data = { tatus: xhr.status, textStatus: textStatus, responseText: xhr.responseText, headers: xhr.getAllResponseHeaders(), errorThrown: errorThrown };  
>>>>>>> 3c3deb4d66b1bff1b052794fa8c779fd25c44f5b
      correctCallback(runner, step, data, expected);
